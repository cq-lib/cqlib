...
## Welcome to the Cqlib Rust API reference!

## Documentation navigation

### Quantum Circuit (`cqlib_core::circuit`)
...
### Intermediate Representation (`cqlib_core::ir`)
...
### Quantum Information (`cqlib_core::qis`)
...
### Compilation (`cqlib_core::compile`)
...
### Visualization (`cqlib_core::visualization`)
...
### Error Mitigation (`cqlib_core::error_mitigation`)
