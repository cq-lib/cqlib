...
Cqlib 是由中电信量子集团自主研发、专为工程实践打造的量子计算软件开发工具包（SDK）。它提供了统一、稳定、高性能的量子线路编程接口与表示能力。

本套说明文档涵盖[安装教程](1_installation.md)、[快速入门](2_quickstart.md)、[场景化指南](../1_cqlib/0_circuit/0_overview.md)及多种编程语言的 [API 参考](../../../api/cn/python/0_overview.md)，致力于帮助您更顺畅地完成量子计算任务的构建、执行与可视化，全面提升开发效率与使用体验。
...
- **原生生态，QCIS 集成**  
  深度集成国产自主量子指令集 [QCIS](../1_cqlib/1_ir/1_qcis.md)，支持线路与 QCIS 文本之间的双向导入导出。

- **多语协同，开发友好**  
  通过高度抽象的 [Python 接口](../../../api/cn/python/0_overview.md)与底层 [C 接口](../../../api/cn/c/0_overview.md)协同设计，兼顾算法研发效率与系统集成稳定性，支持跨平台、跨语言的混合编程场景。
...
- [量子信息](../1_cqlib/3_qis/0_overview.md)
  提供量子态、算符和量子信息处理相关工具，包括态矢量、密度矩阵、稳定子模拟、Pauli 算符、哈密顿量、量子演化和信息度量等能力。
